...
def main():
	...
	results = ensemble_trainer.bagging_ensemble_training(dataset_dir, model_dir, model_types, n_splits)
	...
	evaluator.evaluate(dataset_dir, model_dir, model_types, voting_type=voting_type, dataset_split=dataset_split)
