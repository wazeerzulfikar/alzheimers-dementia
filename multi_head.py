...
def train_n_folds(model_type, x, y_class, y_reg, n_folds=5, model_dir='default'):
...
def train_a_fold(model_type, x_train, y_train_class, y_train_reg, x_val, y_val_class, y_val_reg, fold, model_dir):
...
def create_intervention_model(longest_speaker_length):
	...
	x = BatchNormalization()(x)
	classifier = Dense(2, activation='softmax', name='clf')(x)

	y = Dense(24, activation='relu')(x)
	y = Dropout(0.2)(y)
...
train_clf_accuracies_1, train_reg_losses_1, val_clf_accuracies_1, val_reg_losses_1, train_clf_accuracies_2, train_reg_losses_2, val_clf_accuracies_2, val_reg_losses_2 = train_n_folds(model_type, X_intervention, y, y_reg, n_folds=5, model_dir=model_dir)
